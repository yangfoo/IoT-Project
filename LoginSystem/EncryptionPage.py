...
lbl = Label(window, text="Message :",bg =BACKGROUND, fg=FOREGROUND, font=("Calibri", 13))
...
def clicked():
    ...
    space.configure(text= "The Encrypted Text is :" + encryption)

btn = Button(window, text="Encrypt", height="2", width="16", bg=BACKGROUND, fg=FOREGROUND, command=clicked)
